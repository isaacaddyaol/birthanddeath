...
$query = $con->query("select  * from tbladmin where adminId = '$changeid'") or die(mysqli_error());
...
$resultt = $con->query("update tbladmin set email ='$email',username='$username',role='$role' where adminId = '$changeid'") or die(mysqli_error());
