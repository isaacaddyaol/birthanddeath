      ...
      <div class="main-panel">
        <div class="content-wrapper">
          ...
          <div class="col-12 grid-margin">
              <div class="card">
                <div class="card-body">
                  <h4 class="mb-0 text-left"> BIRTH REGISTRATION RECORDS</h4><br>
          ...
          while ($row = mysqli_fetch_array($query)) 
{
  ...
  if( $payid==0){
      $alert='<button class="btn btn-danger" >Make payment $</button>';
  }
else{
     $alert='<div class="alert alert-primary" role="alert">Payment made</div>';
}
                            ?>
                                ...
                                <tr>
                                    ...
                                    <td class='pay'><a href="pay.php?email=ofosuke@gmail.com&&amount=150&&birthId=<?php echo $row['birthId'] ?>"> <?php echo $alert ?></a> </td>
