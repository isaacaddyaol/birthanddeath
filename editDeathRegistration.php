...
$querys = mysqli_query("select  * from tblcentre where centreId =".$_SESSION['RegCentre']."") or die(mysqli_error());
...
$row = mysqli_fetch_array($query);
   ...
   ?>
          ...
          <div class="col-12 grid-margin">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title"> UPDATE DEATH REGISTRATION</h4>
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input type="text" value="<?php echo $row['firstName']?>" name= 'firstName' required class="form-control text-only" />
                          </div>
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input type="text" value="<?php echo $row['lastName']?>" name= 'lastName' required class="form-control text-only" />
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input class="form-control" value="<?php echo $row['dateOfDeath']?>" required name="dod" type="date" placeholder="dd/mm/yyyy" />
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input type="text" name="ageDeath" value="<?php echo $row['ageAtDeath']?>" required class="form-control" />
                          </div>
                        </div>
                      </div>
                      <div class="col-md-6">
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input  type="text" value="<?php echo $row['placeOfDeath']?>" name = "placeDeath" required class="form-control"/>
                          </div>
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input  type="text" value="<?php echo $row['address']?>" name = "address" required class="form-control"/>
                          </div>
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input type="text" value="<?php echo $row['lga']?>" name = "lga" required class="form-control" />
                          </div>
                        </div>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <select name="placeOfIssue" required class="form-control select2">
                                <option value="<?php echo $row['placeOfIssue']?>"><?php echo $row['placeOfIssue']?></option>
                      ...
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <select name="registrationCentre" required class="form-control select2">
                                <option value="<?php echo $row['registrationCentre']?>"><?php echo $row['registrationCentre']?></option>
                                <option value="Birth and Registry,Ghana">Birth and Registry, Ghana</option>
                                <option value="KORLE BU TEACHING HOSPITAL">KORLE BU TEACHING HOSPITAL</option>
                                <option value="Mamprobi Polyclinic">Mamprobi Polyclinic</option>
                                <option value="LA Dade Kotopon">LA Dade Kotopon</option>
...
//code for validation of fields goes here
                   ...
                   $firstName = $_POST['firstName'];
                          ...
                          $resultt = mysqli_query("update tbldeath set certNo='".$row['certNo']."',firstName='$firstName',lastName='$lastName',gender='$gender',state='$state',lga='$lga',address='$address',ageAtDeath='$ageDeath',placeOfDeath='$placeDeath',dateOfDeath='$dod',PlaceOfIssue='$Placeissue',regCentre='$regCentre',dateReg='$dateReg' where deathId = '$_SESSION[deathRegId]'") or die(mysqli_error());

                          if($resultt){
                                     
   
                                    echo "   <script type='text/javascript'>
                                                   alert('Death Registration Successfully Updated!');
                                                   window.location= 'DeathReports.php';
                                               </script>";
