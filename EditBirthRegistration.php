...
$querys = $con->query("select  * from tblcentre where centreId =".$_SESSION['RegCentre']."") or die(mysqli_error());
                ...
                <div class="card-body">
                  ...
                  <div class="chart-container">
                    <canvas id="dashboard-area-chart" height="80"></canvas>
                       ...
                       $query = $con->query("select  * from tblbirth where birthId = '$_SESSION[birthRegId]'") or die(mysqli_error());
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input type="text" value="<?php echo $row['fathersName']?>" name= 'fathersName' required class="form-control text-only" />
                          </div>
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input type="text" value="<?php echo $row['mothersName']?>" name= 'mothersName' required class="form-control text-only" />
                          </div>
                        </div>
                      </div>
                    </div>
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <select name="Placeissue" required class="form-control select2">
                                <option value="<?php echo $row['Placeissue']?>"><?php echo $row['Placeissue']?></option>
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <select name="regCentre" required class="form-control select2">
                                <option value="<?php echo $row['regCentre']?>"><?php echo $row['regCentre']?></option>
                                <option value="Birth and Registry,Ghana">Birth and Registry, Ghana</option>
                                <option value="KORLE BU TEACHING HOSPITAL">KORLE BU TEACHING HOSPITAL</option>
                                <option value="Mamprobi Polyclinic">Mamprobi Polyclinic</option>
                                <option value="LA Dade Kotopon">LA Dade Kotopon</option>
