          ...
          <div class="col-12 grid-margin">
              <div class="card">
                <div class="card-body">
                  ...
                  <form class="form-sample" method="post" action="UsersRegistration.php">
...
//code for validation of fields goes here
                                ...
                                $querys = $con->query("select  * from tbladmin where email ='$email'") or die(mysqli_error());
                               ...
                               if( $num > 0){
                                ...
                                echo "   <script type='text/javascript'>
                                alert('User with the Email exists!');
                                window.location= 'UsersRegistration.php';
                            </script>";
                    ...
                    $result =  $con->query("insert into tbladmin (email,username,password,role,RegCentre,dateReg)
                            	values ('$email','$username','$password','$role','$centre','$dateReg')
                                ") or die(mysqli_error());
