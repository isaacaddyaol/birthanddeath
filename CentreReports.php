              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <table id="example"  class="display" style="width:50%">
					        ...
					        <?php
		  $query = $con->query("select  * from tblcentre") or die(mysqli_error());
  ...
  $centreRegId = $row['centreId'];
                            ...
                            ?>
                                ...
                                <tr>
                                    ...
                                    <td><button onClick="deleteItem()"  id="<?php echo $centerId; ?>" class="delete">Delete</button></td>
                                </tr>
...
//code for validation of fields goes here
                   ...
                   $centreName = $_POST['centreName'];
                    ...
                    $result =  $con->query("insert into tblcentre (centreName,state,lga,dateReg)
  ...
  <script>
      function deleteItem() {
    if (confirm("Are you sure you want to delete to center?")) {
        var centerId=(".delete").attr(id);
