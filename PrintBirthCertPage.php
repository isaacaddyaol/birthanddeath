              ...
              <div class="card" >
                <div class="card-body" >
                    <div style="margin-left: 36%">
                        ...
                        <div class="card-title" style="margin-left:15%"><h2><u>BIRTH CERTIFICATE</u></h2></div>
                    </div>
                    ...
                    <form class="form-sample" method="post" action="BirthRegistration.php">
                            ...
                            <div class="col-md-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        <?php
                                        $certNo = $row['certNo'];
                                        $qrData = urlencode("http://localhost/birthanddeath/PrintBirthCertPage.php?birthRegId=" . $certNo);
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <u><?php echo $row['genotype'];?></u>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group row">
                                    <label class="col-sm-3 col-form-label">Weight at Birth:</label>
                                    <div class="col-sm-9">
                                        <u><?php echo $row['weight'];?> kg</u>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <p>This is to certify that the birth details recorded herein have been registered on <u><?php echo $row['dateReg'];?></u> at <u><?php echo $row['regCentre'];?></u></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row mt-4">
                            <div class="col-md-12 text-center">
                                ...
                                <a href="PrintBirthCert.php" class="btn btn-light">Back to List</a>
                            </div>
                        </div>
                    </form>
                </div>
...
<script src="https://cdn.jsdelivr.net/npm/qrcode@1.5.0/lib/browser.min.js"></script>
...
<script>
    jQuery('#qrcode').qrcode("<?php echo $row['certNo'];?>");
</script>
